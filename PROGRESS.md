...
已从“模板展示型原型”调整为“输入驱动型三模块原型”，并在 v0.2.3 中加入产品说明入口和全局沟通方式设置。
...
- 模块 1 的无效下拉项已删除；“当前沟通方式”改为全局设置。
- 生成后会自动滚动到输出区域。
- 页面顶部新增“产品说明与安全边界”。
- “当前沟通方式”改成全局设置，并影响三个模块的本地兜底输出。
- API 请求会携带 `communication_mode`，部署后 AI 生成也能参考该参数。
